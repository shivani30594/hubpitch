    ...
    (b = (function () {
        function c(c, d) {
            ...
            (e.defaults = {
                ...
                asNavFor: null,
                prevArrow:
                    '<button type="button" data-role="none" class="slick-prev btn-prev" aria-label="Previous" tabindex="0" role="button">Previous</button>',
                nextArrow:
                    '<button type="button" data-role="none" class="slick-next btn-next" aria-label="Next" tabindex="0" role="button">Next</button>',
                autoplay: !1,
                autoplaySpeed: 3e3,
                infinite: false,
                centerMode: !1,
